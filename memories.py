...
CONTEXT_MEMORY_KEYS = ['context', 'story', 'architecture', 'scenarios', 'requirements', 'solutions']
...
class HumanFeedbackBufferMemory(BaseChatMemory):
    ...
    def buffer(self) -> Any:
        if self.return_messages:
            ...
            string_messages = list(map(lambda m: f"{m.content}", self.chat_memory.messages))
